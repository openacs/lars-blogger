...
create function pinds_blog_entry__title (integer)
returns varchar as '
declare
...
create function pinds_blog_entry__new (
    integer,    -- entry_id
    integer,    -- package_id
    varchar,    -- title
    varchar,    -- content
...
declare
    ...
    p_entry_date           alias for $5;
    p_draft_p              alias for $6;         
...
create function pinds_blog_entry__delete (integer)
returns integer as '
declare
    p_entry_id alias for $1;
begin
