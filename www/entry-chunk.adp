...
<if @comments:rowcount@ not nil>
  <multiple name="comments">
    ...
    <p><if @comments.trackback_p@ eq "f">#lars-blogger.by_commentsauthor#</if><else>#lars-blogger.Trackback_from# <a href="@comments.trackback_url@" title="@comments.trackback_name@">@comments.trackback_name@</a></else> #lars-blogger.lt_on_commentspretty_dat#<if @admin_p@ eq 1> | <a href="@general_comments_package_url@comment-edit?comment_id=@comments.comment_id@&amp;return_url=@comment_return_url@">Edit</a> | <a href="@general_comments_package_url@admin/delete?comment_id=@comments.comment_id@&amp;return_url=@comment_return_url@">Delete</a></if></p>
  </multiple>
