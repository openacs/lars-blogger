...
By <a href="http://www.pinds.com/lars/">Lars Pind</a> and <a href="http://bcuni.net">Simon Carstensen</a><h2>Download</h2><p>The blogger now lives in the <a href="http://openacs.org">OpenACS</a> cvs repository.</p><h2>Getting started</h2><p>Install the package on your system, mount a new instance
...
can add your first blog entry.</p><h2>Syndicating a blog (putting it on your front page)</h2><p>If you want to include a blog as part of another page, that's
...
is used, which is generally not what you want.</p><h2>Technical Info</h2><p>The package fully supports multiple instances. You can mount
...
also available to you in your blog.</p><h2>Permissions</h2><ul>
...
</ul><h2>weblogs.com update ping</h2><p>There are a couple parameters governing this feature. You can
...
page. Thanks to Jerry Asher for the code to do this.</p><h2>RSS Feed</h2><p>The RSS feed is version 1.0 only, and uses the rss-support
...
parameters.</p><h2>XML-RPC APIs</h2><p>The Blogger and MetaWeblog APIs are supported. An <a href="http://archipelago.phrasewise.com/rsd">RSD</a> link is placed on
...
XML-RPC.</p><h2>Posting From News Aggregator via URL</h2><p>Some news aggregators can blog items you read via simply sending
