...
set page_title "[_ lars-blogger._Draft]"
...
lappend elements publish {
    ...
    link_html { title "[_ lars-blogger._Publish]" }
    html { align center }
}
lappend elements delete {
    ...
    link_html { title "[_ lars-blogger._Delete_1]" }
}
